...
# =============================================================================    
    ...
    def setup(self):
        ...
        self.btn_mathe_script = QPushButton(self)
        self.btn_mathe_script.setMinimumSize(QSize(0, 30))
        self.btn_mathe_script.setMaximumSize(QSize(16777215, 30))
        self.verticalLayout.addWidget(self.btn_mathe_script)
        ...
        self.horizontalLayout_3.addWidget(self.plain_text_edit_conmandline)
        self.gridLayout = QGridLayout()
        self.gridLayout.setSpacing(4)
        self.btn_add_paras = QPushButton(self.group_box_commandline)
        self.btn_add_paras.setMinimumSize(QSize(0, 30))
        self.btn_add_paras.setMaximumSize(QSize(16777215, 30))
        self.gridLayout.addWidget(self.btn_add_paras, 0, 0, 1, 2)
        self.btn_add_funs = QPushButton(self.group_box_commandline)
        self.btn_add_funs.setMinimumSize(QSize(0, 30))
        self.btn_add_funs.setMaximumSize(QSize(16777215, 30))
        self.gridLayout.addWidget(self.btn_add_funs, 0, 2, 1, 2)
        self.btn_clear_input = QPushButton(self.group_box_commandline)
        self.btn_clear_input.setMinimumSize(QSize(0, 30))
        self.btn_clear_input.setMaximumSize(QSize(16777215, 30))
        self.gridLayout.addWidget(self.btn_clear_input, 1, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.btn_sub, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_mult, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_left_bra, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_right_bra, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_square, 3, 2, 1, 1)
...
#        self.gridLayout.addItem(spacerItem2, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_abs, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_pow, 4, 1, 1, 1)
        self.btn_log_e = QPushButton(self.group_box_commandline)
        self.btn_log_e.setMinimumSize(QSize(40, 30))
        self.btn_log_e.setMaximumSize(QSize(40, 30))
        self.btn_log_e.setFont(font_10)
        self.gridLayout.addWidget(self.btn_log_e, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_lg, 4, 3, 1, 1)
...
#        self.gridLayout.addItem(spacerItem3, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_sin, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_cos, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btn_tan, 5, 2, 1, 1)
        self.btn_pi = QPushButton(self.group_box_commandline)
        self.btn_pi.setMinimumSize(QSize(40, 30))
        self.btn_pi.setMaximumSize(QSize(40, 30))
        self.btn_pi.setFont(font_10)
        self.gridLayout.addWidget(self.btn_pi, 5, 3, 1, 1)
...
#        self.gridLayout.addItem(spacerItem8, 4, 3, 1, 1)
        ...
        self.hlayout_gbsp = QHBoxLayout(self.group_box_result_paras)
        self.hlayout_gbsp.setContentsMargins(2, 2, 2, 2)
        self.hlayout_gbsp.setSpacing(2)
        ...
        self.hlayout_gbsp.addWidget(self.tree_widget_result_paras)
        self.vlayout_btn = QVBoxLayout()
        self.vlayout_btn.setSpacing(2)
        self.btn_dataview = QPushButton(self.group_box_result_paras)
        self.btn_dataview.setMinimumSize(QSize(84, 30))
        self.btn_dataview.setMaximumSize(QSize(84, 30))
        self.vlayout_btn.addWidget(self.btn_dataview)
        self.btn_clc = QPushButton(self.group_box_result_paras)
        self.btn_clc.setMinimumSize(QSize(84, 30))
        self.btn_clc.setMaximumSize(QSize(84, 30))
        self.vlayout_btn.addWidget(self.btn_clc)
        si = QSpacerItem(20, 40, QSizePolicy.Minimum, QSizePolicy.Expanding)
        self.vlayout_btn.addItem(si)
        self.hlayout_gbsp.addLayout(self.vlayout_btn)
...
#----------yanhua加
        ...
        self.btn_dataview.clicked.connect(self.slot_viewdata)
        ...
        self.btn_log_e.clicked.connect(self.slot_send_op_func_str)
        ...
        self.btn_pi.clicked.connect(self.slot_send_op_func_str)
...
#            yanhua修改结束
    ...
    def slot_send_op_func_str(self):
        ...
        if sender == self.btn_log_e:
            self.signal_op_fun_str.emit('ln()')
        ...
        if sender == self.btn_pi:
            self.signal_op_fun_str.emit('pi')
...
#        self.btn_last_cmd.setText(_translate('MathematicsWindow', '上条指令'))
        ...
        self.btn_dataview.setText(_translate('MathematicsWindow', '查看数据'))
        ...
        self.btn_log_e.setText(_translate('MathematicsWindow', 'ln'))
        ...
        self.btn_pi.setText(_translate('MathematicsWindow', 'Pi'))
