...
#        self.horizontalLayout.addWidget(self.btn_last_cmd)
        ...
        self.btn_dataview = QPushButton(self.group_box_commandline)
        self.btn_dataview.setMinimumSize(QSize(0, 24))
        self.btn_dataview.setMaximumSize(QSize(16777215, 24))
        self.horizontalLayout.addWidget(self.btn_dataview)
